...
export async function GET(): Promise<NextResponse<ApiResponse>> {
  try {
    ...
    console.error("[Presets API] GET error:", error instanceof Error ? error.message : "Unknown");
...
export async function POST(request: NextRequest): Promise<NextResponse<ApiResponse>> {
  try {
    ...
    console.error("[Presets API] POST error:", error instanceof Error ? error.message : "Unknown");
