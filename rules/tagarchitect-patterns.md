...
- Rationale: PostgreSQL handles concurrent credit deductions with ACID transactions. Prisma provides type-safe queries and migrations.
...
## [SECTION 3: CONSOLIDATED RULES]

- Never use #000000 (Use slate-900).
- All image logic must resize to < 512px locally first.
- All credit deductions must be atomic transactions.
